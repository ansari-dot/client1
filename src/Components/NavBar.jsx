...
//         {/* Mobile Button */}
        <div className="mt-8 px-6">
          <button
            ...
            className="w-full bg-[#15487d] text-white px-4 py-4 rounded-full hover:bg-blue-900 transition-all duration-300"
          >
            Switch to Digital Security
          </button>
        </div>
...
const NavBar = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-6 py-2 whitespace-nowrap transition-all duration-300 ${isScrolled ? 'bg-white border-b border-gray-200' : 'backdrop-blur-md bg-white/10 border-b border-white/20'}`}
      >
